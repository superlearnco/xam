...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Terms of Service | XAM" },
    {
      name: "description",
      content:
        "Terms of Service for XAM - AI-native assessment workspace for teachers",
    },
  ];
}
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                agreement between you ("User," "you," or "your") and Superlearn
                ("Company," "we," "us," or "our") governing your access to and
                use of XAM, an AI-native assessment workspace for teachers (the
                "Service").
              </p>
              <p className="mb-4">
                By accessing or using the Service, you agree to be bound by
                these Terms. If you do not agree to these Terms, you may not
                access or use the Service. These Terms apply to all users,
                including educators, administrators, and any other individuals
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                XAM is a cloud-based platform that enables educators to create,
                manage, and deliver assessments, including tests, quizzes, and
                assignments. The Service includes:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                for any other reason we deem necessary to protect the Service or
                other users.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                You may use the Service only for lawful educational purposes,
                including:
              </p>
              <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <ul className="list-disc pl-6 mb-4 space-y-2">
                ...
                <li>
                  ...
                  offensive, defamatory, or violates intellectual property
                  rights
                </li>
                <li>
                ...
                <li>
                  Use the Service to create assessments that promote
                  discrimination, harassment, or illegal activities
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                submit to the Service ("User Content"), including assessments,
                questions, rubrics, and student data. By using the Service, you
                grant us a limited, non-exclusive, worldwide, royalty-free
                license to use, store, and process your User Content solely for
              ...
              <p className="mb-4">
                The Service, including its software, design, features, and
                functionality, is owned by Superlearn and protected by
              ...
              <p className="mb-4">
                Content generated using our AI features may be based on training
                data from various sources. While you own the content you create,
                AI-generated content may not be eligible for copyright
                protection in some jurisdictions. We make no warranties
              ...
              <p className="mb-4">
                The Service may contain content from third parties, including AI
                services provided by OpenAI. Such content is subject to the
                respective third parties' terms and conditions.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                pricing. Current plans include Starter, Scale, and Enterprise
                tiers. Subscription fees are billed monthly or annually as
              ...
              <p className="mb-4">
                Payments are processed securely through Polar.sh. By
                subscribing, you agree to pay all fees associated with your
                subscription plan. All fees are non-refundable except as
                required by law or as otherwise specified in these Terms.
              </p>
              ...
              <p className="mb-4">
                ...
                your subscription at any time through your account settings or
                by contacting us. Cancellation will take effect at the end of
              ...
              <p className="mb-4">
                ...
                Price changes will apply to your next billing cycle after the
                notice period.
              </p>
              ...
              <p className="mb-4">
                ...
                provide refunds at our sole discretion in exceptional
                circumstances. If you believe you are entitled to a refund,
                please contact us.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                If you use the Service to collect, store, or process student
                information, you are responsible for:
              </p>
              <ul className="list-disc pl-6 mb-4 space-y-2">
                <li>
                  Complying with all applicable privacy laws, including FERPA
                  and COPPA
                </li>
                <li>
                  Obtaining necessary consents from students, parents, or
                  guardians
                </li>
                <li>
                  Ensuring student data is used only for educational purposes
                </li>
                <li>
                  Maintaining appropriate security measures for student
                  information
                </li>
                <li>
                  Providing students and parents with access to their data as
                  required by law
                </li>
              </ul>
              <p className="mb-4">
                We act as a data processor for student information you provide.
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                interruptions, or security issues. We reserve the right to:
              </p>
              <ul className="list-disc pl-6 mb-4 space-y-2">
                <li>
              ...
              <p className="mb-4">
                ...
                service interruptions or changes that may affect your use of the
                Service.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                AI-generated content is provided for assistance only. You are
                responsible for reviewing, editing, and verifying all
                AI-generated content before use. We do not guarantee the
              ...
              <p className="mb-4">
                ...
                US IN THE TWELVE (12) MONTHS PRIOR TO THE EVENT GIVING RISE TO
                THE LIABILITY.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                You agree to indemnify, defend, and hold harmless Superlearn,
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                terminate by canceling your account and discontinuing use of the
                Service. We may terminate or suspend your access to the Service
              ...
              <ul className="list-disc pl-6 mb-4 space-y-2">
                ...
                <li>
                  We may delete your account and User Content, subject to our
                  data retention policies
                </li>
                <li>
                  You remain responsible for any fees incurred before
                  termination
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                with the laws of the jurisdiction in which Superlearn operates,
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                the Service and may cancel your account.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                ...
                these Terms or our rights and obligations hereunder without
                restriction.
              </p>
              ...
              <p className="mb-4">
                ...
                <br />
                Legal Email: legal@superlearn.com
                <br />
                Website:{" "}
                <a
